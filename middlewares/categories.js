...
const checkIsCategoryExists = async (req, res, next) => {
  // Среди существующих в базе категорий пытаемся найти категорию с тем же именем, с которым хотим создать новую категорию
...
module.exports = { findAllCategories, checkIsCategoryExists, createCategory, findCategoryById, updateCategory, deleteCategory, checkEmptyName };